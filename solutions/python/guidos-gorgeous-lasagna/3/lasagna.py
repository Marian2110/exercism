...
def preparation_time_in_minutes(number_of_layers: int):
    ...
    :return: int - preparation time (in minutes) based on the lasagna layers.
...
def elapsed_time_in_minutes(number_of_layers: int, elapsed_bake_time: int):
    ...
    Function should return the total minutes you have been in the
    kitchen cooking — your preparation time layering + the time the
